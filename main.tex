...
\ctparttext{Where we explain the variables selected to study, their
interest for this project, and how we selected them.}
...
\ctparttext{Where we talk about the models used to predict the
  \textit{Bitcoin} price and their characteristics.}
...
\ctparttext{Where we explain what tools did we built and what third
party ones did we use in order to complete the experiments designed.}
\part{Implementation}
...
\ctparttext{Where we discuss what we have learned in this project and
what future works can be derived from the present..}
\part{Discussion}
