...
% Set the encoding of your files. UTF-8 is the only sensible encoding
% nowadays. If you can't read äöüßáéçèê∂åëæƒÏ€ then change the
% encoding setting in your editor, not the line below. If your editor
...
\newcommand{\myTitle}{Comparative study of Vector Autoregression and
Recurrent Neural Network applied to Bitcoin forecasting\xspace} 
