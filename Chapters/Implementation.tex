...
The dataset is comprised of one integer data point each day, at
...
The dataset is comprised of one real number data point each day, at
18:15:05, spanning from 03/01/2009 to 03/05/2016.
...
transaction amount itself, been the median, shown in
\autoref{tab:cost-per-transaction-percent}, $3.283375136886966\%$.
